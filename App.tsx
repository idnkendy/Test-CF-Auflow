...
import ReRender from './components/ReRender'; // New Import
...
const App: React.FC = () => {
  ...
  const [showCreditModal, setShowCreditModal] = useState(false); // Modal State
              ...
              <div className="relative flex flex-col flex-grow overflow-hidden">
                  <main ref={mainContentRef} className="flex-1 bg-surface/90 dark:bg-[#191919]/90 backdrop-blur-md overflow-y-auto scrollbar-hide p-3 sm:p-6 lg:p-8 relative z-0 transition-colors duration-300" style={{ WebkitOverflowScrolling: 'touch' }} >
                      ...
                      <ErrorBoundary>
                        ...
                        {/* 
                            IMPORTANT: Passed onInsufficientCredits handler to tools that use payments.
                        */}
