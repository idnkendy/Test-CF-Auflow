            ...
            <div className="bg-surface dark:bg-dark-bg p-8 rounded-2xl shadow-2xl border border-border-color dark:border-gray-700">
                <div className="text-center mb-6">
                    ...
                    <p className="text-sm text-text-secondary dark:text-gray-400 mt-2">
                        {isLogin ? 'Chào mừng bạn quay trở lại' : 'Bắt đầu hành trình sáng tạo của bạn'}
                    </p>
                </div>
                ...
                <form onSubmit={handleEmailAuth} className="space-y-4">
                    <div>
                        ...
                        <input
                            ...
                            className="w-full bg-main-bg dark:bg-gray-800 border border-border-color dark:border-gray-600 rounded-lg p-3 text-text-primary dark:text-white focus:ring-2 focus:ring-[#7f13ec] focus:outline-none transition-all"
                    ...
                    <button
                        ...
                        className="w-full bg-[#7f13ec] hover:bg-[#690fca] text-white font-bold py-3 px-4 rounded-xl transition-all shadow-lg shadow-purple-500/20 flex justify-center items-center mt-2"
                    >
                ...
                <div className="mt-6 text-center text-sm text-text-secondary dark:text-gray-400">
                    {isLogin ? (
                        <>
                            Chưa có tài khoản?{' '}
                            <button onClick={() => setIsLogin(false)} className="text-[#7f13ec] hover:underline font-semibold">
                                Đăng ký ngay
                            </button>
                        </>
                    ) : (
                        <>
                            Đã có tài khoản?{' '}
                            <button onClick={() => setIsLogin(true)} className="text-[#7f13ec] hover:underline font-semibold">
                                Đăng nhập
                            </button>
                        </>
                    )}
