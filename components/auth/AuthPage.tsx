...
interface AuthPageProps {
  onGoHome: () => void;
  initialMode?: 'login' | 'signup'; // Kept for compatibility but unused logic
}
            ...
            <div className="bg-surface dark:bg-dark-bg p-8 rounded-2xl shadow-xl border border-border-color dark:border-gray-700">
                <div className="text-center mb-8">
                    ...
                    <p className="text-text-secondary dark:text-gray-400 text-sm leading-relaxed">
                        Đăng nhập để trải nghiệm đầy đủ tính năng AI và quản lý các dự án thiết kế của bạn.
                    </p>
                </div>
                ...
                <div className="space-y-4">
                    <button
                        ...
                        className="w-full flex justify-center items-center gap-3 bg-white hover:bg-gray-50 text-gray-900 font-bold py-3.5 px-4 rounded-xl transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed border border-gray-300 shadow-sm hover:shadow-md transform hover:-translate-y-0.5"
                    >
