            ...
            <div className="bg-surface dark:bg-dark-bg p-8 rounded-2xl shadow-2xl border border-border-color dark:border-gray-700">
                <div className="text-center mb-8">
                    ...
                    <p className="text-sm text-text-secondary dark:text-gray-400 mt-2">
                        Đăng nhập để bắt đầu hành trình sáng tạo
                    </p>
                </div>
                ...
                <div className="space-y-4">
                    <button
                        ...
                        className="w-full flex justify-center items-center gap-3 bg-white dark:bg-gray-800 hover:bg-gray-50 dark:hover:bg-gray-700 text-gray-700 dark:text-gray-200 font-semibold py-4 px-4 rounded-xl transition-all duration-200 border border-gray-300 dark:border-gray-600 shadow-sm group hover:shadow-md"
                    >
                        {loading ? <Spinner /> : <GoogleIcon />}
                        <span className="text-base group-hover:text-primary dark:group-hover:text-white transition-colors">Tiếp tục với Google</span>
                    </button>
                </div>
            </div>
