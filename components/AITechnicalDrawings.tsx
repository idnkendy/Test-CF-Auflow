        ...
        try {
            ...
            if (successfulUrls.length > 0) {
                ...
                successfulUrls.forEach(url => historyService.addToHistory({ 
                    tool: Tool.AITechnicalDrawings, prompt: fullPrompt, 
                    ...
                    <div className="bg-gray-100 dark:bg-black/20 p-3 sm:p-4 rounded-2xl space-y-4 border border-gray-200 dark:border-white/5">
                        <div>
                            ...
                            <div className="p-3 rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-[#121212] shadow-inner">
                                <textarea rows={window.innerWidth < 768 ? 4 : 8} className="w-full bg-transparent outline-none text-xs sm:text-sm resize-none font-medium text-text-primary dark:text-white" placeholder="Yêu cầu kỹ thuật..." value={prompt || ''} onChange={(e) => onStateChange({ prompt: e.target.value })} />
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="flex-1 bg-gray-100 dark:bg-[#121212] relative overflow-hidden flex items-center justify-center min-h-[300px]">
                        {resultImages.length > 0 ? (
                            ...
                            <div className="w-full h-full flex flex-col items-center justify-center py-20 opacity-20 select-none bg-main-bg dark:bg-[#121212] p-8 text-center">
                                <span className="material-symbols-outlined text-4xl sm:text-6xl mb-4">architecture</span>
