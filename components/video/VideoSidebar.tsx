...
interface VideoSidebarProps {
    activeItem: string;
    onItemClick: (item: typeof sidebarItems[0]) => void;
    onGoHome: () => void;
}
        ...
        <aside className="w-[70px] md:w-64 bg-surface dark:bg-[#191919] border-r border-border-color dark:border-[#302839] flex flex-col z-10 flex-shrink-0 transition-colors duration-300">
            <div className="p-2 md:p-4 flex flex-col gap-2">
                <div className="flex items-center gap-1 mb-6 px-2">
                    <button onClick={onGoHome} className="text-text-secondary dark:text-gray-400 hover:text-text-primary dark:hover:text-white flex items-center gap-2 transition-colors flex-1" title="Trang chủ">
